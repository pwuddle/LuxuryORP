      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8" id="footer-content">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 text-xs">
          ...
          <div className="md:col-span-3 space-y-3">
            <h5 className={`font-bold uppercase ${textSecondary} tracking-wider`}>Informatie</h5>
            <ul className="space-y-2 text-[#8e9297]">
              <li>
              ...
              <li>
                <a href="#" className="hover:text-[#A87E43] transition-colors flex items-center gap-1">
                  Render Live Host <ExternalLink className="w-3 h-3" />
                </a>
              </li>
            </ul>
          </div>

          {/* Column 3: Discord Invitation CTA (The key user request) */}
          <div className="md:col-span-3 space-y-4">
            <h5 className={`font-bold uppercase ${textSecondary} tracking-wider`}>Join Our Discord</h5>
            
            <p className={`${textMuted} leading-relaxed`}>
              De officiële link volgt op een later moment. Gebruik onderstaande knop om verbinding te maken zodra de vloot gereed is.
            </p>
