...
export default function Home({ isDarkMode, onNavigate, onStartOAuth, user }: HomeProps) {
  ...
  return (
    ...
    >
      ...
      {/* Main Row: Dealership Live Status and Discord Invitation */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch" id="details-row">
        {/* Dealership Live Status */}
        <div className={`lg:col-span-4 p-6 rounded-xl ${bgCard} flex flex-col justify-center shadow-md space-y-4`}>
          <h3 className={`text-base font-extrabold ${textPrimary} border-b border-[#A87E43]/30 pb-2`}>
            Dealershop Status
          </h3>
        ...
        <div className="lg:col-span-8 flex flex-col justify-between p-6 bg-[#5865F2] hover:bg-[#5865F2]/95 text-white rounded-xl shadow-xl border-t-4 border-[#A87E43]">
